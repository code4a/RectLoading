...
public abstract class Indicator extends Drawable implements Animatable {
    ...
    private HashMap<ValueAnimator, ValueAnimator.AnimatorUpdateListener> mUpdateListeners = new LinkedHashMap<>();
     ...
     * or
     * updateColors(Color.parseColor("#FF4081"))
     * or
     * updateColors(0xFF00FF00)
     * or
    ...
    public void updateColors(@ColorInt int leftTop, @ColorInt int leftBottom, @ColorInt int rightBottom, @ColorInt int rightTop) {
        mColors[0] = leftTop;
        mColors[1] = rightBottom;
        mColors[2] = leftBottom;
        mColors[3] = rightTop;
    }
